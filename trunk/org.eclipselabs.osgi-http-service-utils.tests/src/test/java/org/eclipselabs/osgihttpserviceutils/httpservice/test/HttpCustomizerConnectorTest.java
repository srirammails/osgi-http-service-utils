...
import org.eclipselabs.osgihttpserviceutils.httpservice.test.utils.CustomizerConnectorProbe;
...
public class HttpCustomizerConnectorTest {
    ...
    public TestAddress testCustomizerBundle( TestProbeBuilder builder )
    {
        return builder
        		...
        		.addTest(CustomizerConnectorProbe.class);
    }
