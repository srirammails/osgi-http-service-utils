...
public class CustomizerProbe {
	...
	private void startHttpServiceWithCustomizer(BundleContext bundleContext)
			throws Exception {

		String customizeClassPropertyName = "org.eclipselabs.osgihttpserviceutils.httpservice.customizer.class";
		System.setProperty(customizeClassPropertyName,
				JettyTestCustomizer.class.getName());

		ServiceTracker httpAdminServiceTracker = new ServiceTracker(
				bundleContext, HttpAdminService.class.getName(), null);
