/*******************************************************************************
 * Copyright (c) 2007, 2009 IBM Corporation and others. All rights
...
public interface JettyConstants
{
  ...
  /**
   * name="http.port" type="Integer" (default: 0 -- first available
   * port)
   */
  public static final String HTTP_PORT = "http.port"; //$NON-NLS-1$

  /**
   * name="http.host" type="String" (default: 0.0.0.0 -- all network
   * adapters)
   */
  public static final String HTTP_HOST = "http.host"; //$NON-NLS-1$

  /**
   * name="http.nio" type="Boolean" (default: true, with some
   * exceptions for JREs with known NIO problems)
   * @since 1.1
   */
  ...
  /**
   * name="https.port" type="Integer" (default: 0 -- first available
   * port)
   */
   ...
   * <code>org.eclipse.equinox.http.jetty.JettyCustomizer</code> and
   * has a public no-arg constructor; the class must be supplied via a
   * fragment to this bundle's classpath)
   * @since 1.1
   */
