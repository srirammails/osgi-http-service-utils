package org.eclipselabs.osgihttpserviceutils.httpservice.demo.httpadmin;
...
public class HTTPAdminDemo {
	...
	public void start() {
		...
		httpServerInstance = 
			httpAdminService.createHttpServer("default")
	...
	@Deactivate
	public void stop() {
		logger.info("Shutdown HTTP server instance.");
