...
public class HttpServiceTest {
	...
	public Mockery mockery = new Mockery(){{
	...
	@Before public void setUp() throws Exception {
		...
		httpServerManager = mockery.mock(HttpServerManager.class);
	...
	@Test public void shutdown() throws Exception {
		...
		assertThat(httpService.getHttpServerInstances().size(), is(0));
	}
	...
	@Test public void addRequestInterceptors() throws Exception {
		...
		assertThat(httpService.getRequestInterceptors().contains(requestInterceptor), is(true));
	}
	...
	@Test public void removeRequestInterceptors() throws Exception {
		...
		assertThat(httpService.getRequestInterceptors().contains(requestInterceptor), is(false));
	}
	...
	@Test public void createHttpServerManager_RequestInterceptors() throws Exception {
		...
		assertThat(httpServerManager.getRequestInterceptors().contains(requestInterceptor), is(true));
	}
